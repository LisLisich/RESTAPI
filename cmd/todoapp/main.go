...
import (
	...
	core_config "github.com/LisLisich/fintask/internal/core/config"
	...
	health_transport_http "github.com/LisLisich/fintask/internal/features/health/transport/http"
	identity_google_provider "github.com/LisLisich/fintask/internal/features/identity/provider/googleoidc"
	identity_jwt_provider "github.com/LisLisich/fintask/internal/features/identity/provider/jwt"
	identity_password_provider "github.com/LisLisich/fintask/internal/features/identity/provider/password"
	identity_token_provider "github.com/LisLisich/fintask/internal/features/identity/provider/token"
	identity_postgres_repository "github.com/LisLisich/fintask/internal/features/identity/repository/postgres"
	identity_service "github.com/LisLisich/fintask/internal/features/identity/service"
	identity_transport_http "github.com/LisLisich/fintask/internal/features/identity/transport/http"
	identity_http_middleware "github.com/LisLisich/fintask/internal/features/identity/transport/http/middleware"
	notifications_smtp_provider "github.com/LisLisich/fintask/internal/features/notifications/provider/smtp"
	notifications_postgres_repository "github.com/LisLisich/fintask/internal/features/notifications/repository/postgres"
	notifications_service "github.com/LisLisich/fintask/internal/features/notifications/service"
	notifications_transport_http "github.com/LisLisich/fintask/internal/features/notifications/transport/http"
	payments_yookassa_provider "github.com/LisLisich/fintask/internal/features/payments/provider/yookassa"
	payments_postgres_repository "github.com/LisLisich/fintask/internal/features/payments/repository/postgres"
	payments_service "github.com/LisLisich/fintask/internal/features/payments/service"
	payments_transport_http "github.com/LisLisich/fintask/internal/features/payments/transport/http"
	statistics_postgres_repository "github.com/LisLisich/fintask/internal/features/statistics/repository/postgres"
	statistics_service "github.com/LisLisich/fintask/internal/features/statistics/service"
	statistics_transport_http "github.com/LisLisich/fintask/internal/features/statistics/transport/http"
	task_postgres_repository "github.com/LisLisich/fintask/internal/features/tasks/repository/postgres"
	task_service "github.com/LisLisich/fintask/internal/features/tasks/service"
	tasks_transport_http "github.com/LisLisich/fintask/internal/features/tasks/transport/http"
	tasks_transport_http_v2 "github.com/LisLisich/fintask/internal/features/tasks/transport/http/v2"
	users_postgres_repository "github.com/LisLisich/fintask/internal/features/users/repository/postgres"
	users_service "github.com/LisLisich/fintask/internal/features/users/service"
	users_transport_http "github.com/LisLisich/fintask/internal/features/users/transport/http"
	wallet_postgres_repository "github.com/LisLisich/fintask/internal/features/wallet/repository/postgres"
	wallet_service "github.com/LisLisich/fintask/internal/features/wallet/service"
	wallet_transport_http "github.com/LisLisich/fintask/internal/features/wallet/transport/http"
	web_fs_repository "github.com/LisLisich/fintask/internal/features/web/repository/file_system"
	web_service "github.com/LisLisich/fintask/internal/features/web/service"
	web_transport_http "github.com/LisLisich/fintask/internal/features/web/transport/http"
	"go.uber.org/zap"

	_ "github.com/LisLisich/fintask/docs"
)
